...
const SubscribeNewsLetter = () => {
  return (
    <div className="py-12 md:py-24 container mx-auto px-3 xl:px-0">
        ...
        <div className="w-full xl:flex-2 lg:w-2/3 bg-light-secondary px-6 md:px-12 py-10 md:py-0 flex flex-col justify-center md:pb-6 lg:pb-0">
          ...
          <form className=" md:w-11/12 lg:w-9/12 flex mx-auto md:mx-0 pt-4 lg:pt-6">
            <input
              ...
              className="flex-1 p-2  md:px-4 md:py-3 rounded-l-md border border-light-text/60 focus:outline-none focus:ring-2 focus:ring-light-accent text-sm md:text-base"
            />
            <button
              type="submit"
